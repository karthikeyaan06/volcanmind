      ...
      <div className="container mx-auto px-6">
        ...
        <div id="products" className="grid md:grid-cols-2 gap-12 mb-20">
          <div>
            ...
            <a href="https://teabasket.shop/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-border rounded-lg px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary transition-colors">
